...
function State() {
    ...
    React.useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_BASE_URL}/visualisations/state-to-inquiries-pie`)
            .then((response) => {
        ...
        axios
            .get(`${process.env.REACT_APP_API_BASE_URL}/visualisations/state-to-inquiries-bar`)
            .then((response) => {
                console.log("res data", response.data);
